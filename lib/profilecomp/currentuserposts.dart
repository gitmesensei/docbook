...
import '../feedpagecomp/posts/comments/comments.dart';
import 'package:recase/recase.dart';


class CurrentUserPostsless extends StatelessWidget {
  @override
...
class _PostsState extends State<CurrentUserPosts> {
  ...
  void _loadCurrentUser() {
    ...
    try {
      ...
      return Padding(
        ...
        child: StreamBuilder(
            stream:
            Firestore.instance.collection("Users").document(currentuser.uid.toString()).collection('Posts').orderBy('timestamp',descending: true).snapshots(),
            builder: (BuildContext context,
                AsyncSnapshot<QuerySnapshot> snap) {
              if (!snap.hasData) return new Center(child: CircularProgressIndicator(),);
                      ...
                      child: Wrap(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: ds['image_url']==null ? Text('') :Image(image: NetworkImage(ds['image_url'])),
                          ),
                          Padding(
                    ...
                    onPressed: () {
                      showModalBottomSheet(
                        ...
                        builder: (context) => Container(
                            ...
                            child:Comments(blogid, currentid, ds)
                        ),
                      );
                    },
                  ),
