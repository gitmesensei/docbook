...
class _FourthState extends State<ProfilePage> {
  ...
  void checkFriends()async{
    ...
    try {
      final QuerySnapshot result = await Firestore.instance
          .collection('Users')
          .where('friends', arrayContains: currentuser.uid.toString())
          .getDocuments();
      final List<DocumentSnapshot> documents = result.documents;
      print(documents.length);
      setState(() {
        this.friends= documents.length;
      });
    }catch(e){
           ...
           child: RaisedButton(
             onPressed: () {
               Firestore.instance.collection('Users').document(currentuser.uid.toString()).updateData({
                 ...
                 'request_sent':FieldValue.arrayUnion([widget.userid])
  ...
  void unfriend(){
    showDialog(
      ...
      builder: (BuildContext context) => new CupertinoAlertDialog(
        title: new Text("are you sure you want to unfriend user ?"),
        actions: [ CupertinoDialogAction(
          ...
          onPressed: (){
            Firestore.instance.collection('Users').document(widget.userid).updateData({
              ...
              'friends':FieldValue.arrayRemove([currentuser.uid.toString()])
      ...
      builder: (BuildContext context) => new CupertinoAlertDialog(
        ...
        actions: [ CupertinoDialogAction(
          ...
          onPressed: (){
            ...
            'request_sent':FieldValue.arrayRemove([widget.userid])
